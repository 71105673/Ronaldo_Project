...
축구는 전 세계에서 가장 많은 팬을 보유한 스포츠이자, 우리 모두에게 특별한 추억을 남긴 종목입니다.  
운동장에서 친구들과 뛰놀던 즐거운 기억, 혹은 2002년 월드컵에서 온 국민이 하나 되어 열광했던 순간처럼, 축구는 누구에게나 가슴 뛰는 경험을 선사합니다.  

하지만 현대 사회의 장시간 좌식 생활과 만성 스트레스는 우리의 몸을 약화시키고, 소화 장애와 심혈관계 질환 등 다양한 건강 문제를 유발합니다.  
이러한 문제는 작은 생활 습관 변화와 가벼운 취미 활동을 통해 충분히 극복할 수 있습니다.  

이에 저희는 축구의 짜릿한 순간 중 하나인 **PK(페널티 킥)** 에 주목했습니다.  
PK는 짧은 시간이지만 모든 것이 걸린 긴장감 넘치는 순간이며, 프로젝트 기간 내 도전·열정·재미를 담아내기에 가장 적합한 주제라고 생각했습니다.  

저희가 기획한 게임은 좁은 공간에서도 즐길 수 있는 축구의 재미를 제공하며, 동시에 건강한 생활 습관을 유도합니다.  
즉, **건강과 재미 두 마리 토끼를 잡는 PK 축구 게임**을 개발하게 되었습니다.
...
| **이현수** | (Sobel, Flesh) Filter, Face Detector 설계 및 검증 |
| **정현태** | (Sobel, Flesh) Filter, Face Detector 설계 및 검증 |
