...
def main():
    ...
    uart_ball_col = None # dev05.py에서 추가
    ...
    buttons = {
        ...
        "game": [ImageButton("./image/btn_single.png", screen_width//2 - 280, screen_height//2 + 200, 550, 600, lambda: start_game_mode("single")),
                 ImageButton("./image/btn_multi.png", screen_width//2 + 430, screen_height//2 + 200, 550, 600, lambda: start_game_mode("multi")),
        ...
        "end": [ImageButton("./image/btn_restart.png", screen_width//2 - 300, screen_height - 250, 400, 250, lambda: start_game_mode(game_mode['mode'])),
