...
def main():
    ...
    buttons = {
        "menu": [ImageButton("../image/btn_start.png", screen_width - 300, screen_height - 175, 400, 250, lambda: start_transition("game"), sound=resources["sounds"].get("button")),
                 ImageButton("../image/btn_desc.png", screen_width - 150, 150, 100, 100, lambda: start_transition("info"), sound=resources["sounds"].get("button"))],
    ...
    def draw_webcam_view():
        # ... (기존 webcam_view 로직을 여기에 통합 및 정리) ...
