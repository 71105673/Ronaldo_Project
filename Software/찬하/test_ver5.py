...
def main():
    ...
    selected_grid_cell = None # 선택된 그리드 셀 저장
                ...
                if ret:
                    ...
                    if is_countdown_active:
                        ...
                        if contours:
                            ...
                            if cv2.contourArea(largest_contour) > 500: # 최소 크기 필터링
                                ...
                                # --- FPGA 신호 시뮬레이션 ---
                                # TODO: 이 부분에서 실제 FPGA 신호 전송 코드를 호출합니다.
                    ...
                    if is_countdown_active:
                        ...
                        selected_grid_cell = None # 하이라이트 제거
                else:
                    screen.fill(BLACK)
