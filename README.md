...
본 프로젝트는 **AXI4-Lite 인터페이스**를 기반으로 직접 설계한 **하드웨어 IP**[BTN, UART, SCCB, VGA]를 이용해 SoC 구조로 제작하였고, 임베디드 코딩을 통해 제어했습다. 이를 통해 **카메라(SCCB)와 디스플레이(VGA)를 제어**하고, **UART 통신 프로토콜**을 구현하여 게임의 핵심 기능을 완성했습니다.
